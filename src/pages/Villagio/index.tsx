import { Box, Button, Container, Divider, Flex, Grid, GridItem, Heading, Image, Popover, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverTrigger, Text } from "@chakra-ui/react"
...
const Villagio = () => {
    ...
    return (
        <Box sx={{ fontFamily: "Lexend Giga" }}>
            <Box as="header">
                <Navbar bgOpacity={bgOpacity} sections={sections} scrollToSection={scrollToSection} activeSection={activeSection} />
                        ...
                        <Grid templateColumns='repeat(12, 1fr)' justifyContent='space-between'>
                            <GridItem colSpan={{ base: 12, md: 8, lg: 6 }}>
                                ...
                                <Flex gap='10px' sx={{ marginBlock: '48px' }}>
                                    <Button sx={{ color: '#092B20', backgroundColor: '#FFF', paddingBlock: '22px', fontWeight: 'medium', borderRadius: '100px' }}>Contato</Button>
            ...
            <Grid templateColumns={{ base: 'repeat(12, 1fr)', lg: 'repeat(12, 1fr)', '2xl': 'repeat(2, 1fr)' }}>
                ...
                <GridItem position="relative" _after={{
                    ...
                    <Button position='relative' zIndex={1} sx={{ color: '#092B20', backgroundColor: '#FFF', paddingBlock: '24px', fontWeight: 'medium', borderRadius: '100px', marginTop: '48px', fontSize: '18px' }}>Contato</Button>
                </GridItem>
            </Grid>
                ...
                <Container maxW={'container.xl'}>
                    <Flex flexDirection={{ base: 'column', lg: 'row' }} sx={{ justifyContent: 'space-between', paddingBlock: '100px' }}>
                        ...
                        <Flex marginTop={{ base: '80px', lg: 0}} sx={{ flexDirection: 'column', gap: '16px' }}>
                            ...
                            <Button sx={{ width: 'max-content', color: '#FFF', backgroundColor: 'transparent', paddingBlock: '22px', fontWeight: 'medium', borderRadius: '100px', border: '1px solid #FFF', _hover: { backgroundColor: '#FFF', color: '#092B20' } }} >Contato</Button>
                        </Flex>
                    </Flex>

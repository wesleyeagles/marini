	...
	return (
		<>
			<Helmet>
				...
				{/* description */}
				<meta
					content="Construção civil de empreendimentos, obras e prédios residenciais, de pequeno, médio e grande porte. Empresa com credibilidade e responsabilidade mais de 15 anos."
					name="description"
				/>
				<meta
					content="Construção civil de empreendimentos, obras e prédios residenciais, de pequeno, médio e grande porte. Empresa com credibilidade e responsabilidade mais de 15 anos."

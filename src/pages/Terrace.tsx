                    ...
                    <Stack display={{ sm: 'none', lg: 'flex' }} direction='row' align='center' spacing={{ lg: '52px', xl: '77px' }} justify='center' marginTop='80px'>
                        ...
                        <Stack spacing='44px'>
                            <VStack align='start'>
                                ...
                                <Text as='span' h='25px' color='#860A10' fontSize='20px' fontFamily='FivoLight' display='block'>Stúdio</Text>
                            </VStack>
                        </Stack>
                    </Stack>
                ...
                <Box maxW={{ sm: '93%', md: '738px', lg: '960px', xl: '1247px', '2xl': '1247px' }} m='0 auto'>
                    <div className="flex items-center gap-7 mt-20">
						...
						<div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 gap-y-10 mt-16 terrace-progress">
							...
							<ProgressBar value="79.26" label="Estruturas concreto" />
							<ProgressBar value="54.56" label="Alvenarias" />
							<ProgressBar value="9.45" label="Instalação hidráulica" />
							<ProgressBar value="11.97" label="Instalação elétrica" />
							<ProgressBar value="34.27" label="Revestimentos internos" />
